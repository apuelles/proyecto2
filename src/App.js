...
const productsData = [
  ...
  },
  {
    ...
    price: 8990,
    image: "imagenes/electrolitos.jpg"
  },
  {
    id: 4,
    name: "Pre Workout",
    ...
    <>
      ...
      <section id="contacto">
        ...
        <div className="newsletter-form">
          <input className="newsletter-input" type="email" placeholder="tu@email.com" id="newsEmail" />
          <button 
            className="newsletter-submit" 
            onClick={() => {
              const val = document.getElementById('newsEmail').value;
